        ...
        return <>
            {
                this.props.success ? (
                    ...
                    <form className="form registration-form" onSubmit={this.signUp}>
                        ...
                        <div className="inputComp">
                            <InputElem forwhat="name" labelname="Имя*" id="name" inputwidth="355px" typeattr="name" inputname="name" />
                        </div>
                        <div className="inputComp">
                            <InputElem forwhat="surname" labelname="Фамилия*" id="surname" inputwidth="355px" typeattr="surname" inputname="surname" />
                        </div>
                        <div className="inputComp">
                            <InputElem forwhat="password" labelname="Придумайте пароль*" id="password" inputwidth="355px" typeattr="password" inputname="password" />
                        </div>
                        <div className="reg">
